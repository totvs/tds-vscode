...
export function activate(context: ExtensionContext) {
	...
	context.subscriptions.push(debug.registerDebugAdapterDescriptorFactory(TotvsConfigurationProvider.type, new TotvsDebugAdapterDescriptorFactory()));
	...
	context.subscriptions.push(debug.registerDebugAdapterDescriptorFactory(TotvsConfigurationTdsReplayProvider.type, new TotvsDebugAdapterDescriptorFactory()));
	...
	context.subscriptions.push(debug.registerDebugAdapterDescriptorFactory(TotvsConfigurationWebProvider.type, new TotvsDebugAdapterDescriptorFactory()));
