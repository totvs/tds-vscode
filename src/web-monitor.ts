...
export async function openMonitorView(context: vscode.ExtensionContext): Promise<any> {
	//return openExternalWebMonitorView(context);
	return openEmbeddedWebMonitorView(context);
}

export async function openExternalWebMonitorView(context: vscode.ExtensionContext): Promise<any> {
		  ...
		  <html lang="en" style="height: 100%;">
			...
			<body style="height: 100%; width: 100%">
			  <iframe style="height: auto; min-height: 100%; width: 100%"
				  src="${url}/main?token=${encodeData(data)}" frameborder="0">
			  </iframe>
			</body>
		  </html>
		`
