...
export class ReplayConfigurationPanel extends TdsPanel<TReplayConfigurationModel> {
  ...
  protected getTranslations(): Record<string, string> {
    return {
      ...
      "Add Selector": vscode.l10n.t("Add Selector"),
      ...
      "TDS-Replay file": vscode.l10n.t("TDS-Replay file"),
      "File Generated by TDS-Replay": vscode.l10n.t("File Generated by TDS-Replay"),
      "Password": vscode.l10n.t("Password"),
      "**Options**": vscode.l10n.t("**Options**"),
      "**Include Sources**": vscode.l10n.t("**Include Sources**"),
