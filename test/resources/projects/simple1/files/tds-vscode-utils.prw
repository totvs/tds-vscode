...
Retorna um array multidimensional com todas as informações das propriedades da instáncia da classe contida no objeto informado como parámetro
...
Gera arquivo binary_functions.inc (c++) com a prototipaçõo das funções AdvPL binárias.
@type function
@version  1.0
@author acandido
@since 30/09/2022
