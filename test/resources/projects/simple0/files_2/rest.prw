...
WSRESTFUL produto DESCRIPTION 'produt'
	...
	WSMETHOD POST   NEW    DESCRIPTION 'Inclusão de registro'          WSSYNTAX '/produto/new'                               PATH 'new'           PRODUCES APPLICATION_JSON
	WSMETHOD PUT    UPDATE DESCRIPTION 'Atualização de registro'       WSSYNTAX '/produto/update'                            PATH 'update'        PRODUCES APPLICATION_JSON
	WSMETHOD DELETE ERASE  DESCRIPTION 'Exclusão de registro'          WSSYNTAX '/produto/erase'                             PATH 'erase'         PRODUCES APPLICATION_JSON
END WSRESTFUL
